...
var getLoader = (exports.getLoader = function getLoader() {
  return new _dataloader2.default(function(ids) {
    return (0, _graphqlMongooseLoader.mongooseLoader)(_UserModel2.default, ids);
  });
});

var viewerCanSee = function viewerCanSee(context, data) {
...
var load = (exports.load = (function() {
  var _ref = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee(context, id) {
      var data;
...
var clearCache = (exports.clearCache = function clearCache(_ref2, id) {
          ...
          while (1) {
            switch ((_context2.prev = _context2.next)) {
              case 0:
                ...
                users = _UserModel2.default.find(where, { _id: 1 }).sort({ createdAt: -1 });
